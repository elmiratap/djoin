...
public class JoinTripsList {
    ...
    public JoinTripsList(String destination, int numSeats, String date, String id, String start,
                         String driver, String car) {
        super();
    ...
    public JoinTripsList(String destination, String date, int numSeats, String id,
